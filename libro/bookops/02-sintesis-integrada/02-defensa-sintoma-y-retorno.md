...
```mermaid
flowchart LR
  A["Representacion inconciliable"] --> B["Defensa"]
  B --> C["Se separan"]
  C --> D["Representacion"]
  C --> E["Monto de afecto"]
  D --> F["Grupo psiquico segundo"]
  E --> G["Busca otro destino"]
```
...
```mermaid
flowchart TD
  A["Monto de afecto"] --> B["Cuerpo"]
  A --> C["Otra representacion"]
  A --> D["Expulsion conjunta"]
  B --> E["Conversion<br/>histeria"]
  C --> F["Falso enlace<br/>neurosis obsesiva"]
...
flowchart TD
  A["Representacion inconciliable"] --> B["Conflicto psiquico"]
  B --> C["Defensa"]
  C --> D["Separacion representacion / afecto"]
  D --> E["Representacion segregada"]
  D --> F["Monto de afecto"]
  E --> J["Grupo psiquico segundo"]
  F --> G["Conversion"]
  F --> H["Falso enlace"]
  F --> I["Desestimacion"]
  G --> K["Sintoma histerico"]
  H --> L["Representacion obsesiva"]
  I --> M["Psicosis"]
  K --> N["Retorno de lo reprimido"]
  L --> N
